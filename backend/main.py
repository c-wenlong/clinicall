...
# Twilio Credentials (should be in your .env file)
TWILIO_ACCOUNT_SID = os.getenv("TWILIO_ACCOUNT_SID")
TWILIO_AUTH_TOKEN = os.getenv("TWILIO_AUTH_TOKEN")
TWILIO_CALLER_ID = os.getenv("TWILIO_CALLER_ID")  # Your Twilio phone number

# Ensure credentials are set
if not TWILIO_ACCOUNT_SID or not TWILIO_AUTH_TOKEN or not TWILIO_CALLER_ID:
    raise ValueError(
        "Twilio credentials are missing. Please set them in your .env file."
    )
...
async def start_call(phone_number: str):
    """
    Initiates an outgoing call to the given phone number and connects it to the AI assistant.
    """
    try:
        call = client.calls.create(
            url=f"{NGROK_URL}/incoming-call",  # Change this to your public server URL
            to=phone_number,
